...
checkMagic(choice1, choice2, choice3, choice4)

if totalStats >= 60 and checkPartyStats(ff_classes, stat) and checkMagic(choice1, choice2, choice3, choice4):
